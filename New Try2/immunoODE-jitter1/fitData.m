...
currDname = 'timelines_RES2'; %name of the file with data
...
%     indx = (1:3) %+ (i-1)*1 + 2; %indices for patient-specific parameters, always the first
    indx = (1:1) + (i-1)*1 +2; %only one patient specific paramter
...
save(['./Fit results/',currDname,'1.mat'],'Bfinal','initGuess','patients');
