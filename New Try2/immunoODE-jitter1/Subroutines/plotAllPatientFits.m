function [initCond,BCresponses] =...
    ...
    for pat = 1:numel(res) % for each patient
       ...
       plot(xi, Ei,'LineWidth',2,'Color','b'); % plot effector timeline
       scatter(t1,T0*y1,25,'rd','filled'); % plot the actual tumordata 
       plot(xi, Ti,'LineWidth',2,'Color','r'); % plot tumor timeline on top
